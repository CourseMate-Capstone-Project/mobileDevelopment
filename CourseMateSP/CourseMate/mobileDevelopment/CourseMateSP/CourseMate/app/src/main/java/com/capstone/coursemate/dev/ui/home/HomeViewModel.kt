...
class HomeViewModel : ViewModel() {
    ...
    // Existing MutableLiveData for the text
...
// Function to set/update the recommended courses
    ...
    // New Function: Toggle favorite for a specific course
    fun toggleFavorite(card: com.capstone.coursemate.dev.data.response.recommendationAPI.Course, tokenManager: TokenManager, favouritesRepository: FavoritesRepository) {
