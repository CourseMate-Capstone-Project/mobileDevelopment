...
class ResetPasswordFormActivity : AppCompatActivity() {
    ...
    private fun setupViewVisibility() {
        if (isOtpStage) {
            ...
            binding.prHints.visibility = View.GONE
            binding.btnConfirm.text = getString(R.string.confirm_new_password)
        } else {
            // Show email input
            ...
            binding.prHints.visibility = View.VISIBLE
            binding.btnConfirm.text = getString(R.string.rBtnConfirm)
        }
    }
